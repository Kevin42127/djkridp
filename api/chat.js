...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = `Du bist ein Assistent für die DJKridP Website. Antworte auf Deutsch. Verwende KEINE * Zeichen, nur Bindestriche (-) für Listen. Verwende reines Textformat ohne Markdown.`;
